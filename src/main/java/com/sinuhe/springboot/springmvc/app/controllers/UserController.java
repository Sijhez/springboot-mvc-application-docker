...
@SessionAttributes({"user"}) // en singular, ya que es el OBJETO que vamos a persistir en la session
public class UserController {
    ...
    @PostMapping
    public String form(@Valid User user, BindingResult result, Model model, RedirectAttributes redirectAttributes, SessionStatus status) {
